...
class AIControllerV2(Controller):
    ...
    def search(self):
        ...
        heapq.heappush(node_queue, get_p_vec2(
            self.snake.body[0], self.fruit.get_position(), 0))
        ...
        while len(node_queue) > 0:
            ...
            for move in ABLE_MOVES:
                ...
                if i == 0:
                    if move_vec.dot_product(self.snake.direction.get_opposite()
                                            .get_vector()) > 0:
                        continue
                ...
                # valid moves
                p_node = get_p_vec2(
                    check_pos, self.fruit.get_position(), current_node.g + 1.0)
