...
def hex_to_color_tuple(hex: str):
    ...
    if len(t_hex) == 3:
        t_hex = "{}{}{}{}{}{}".format(t_hex[0], t_hex[0], t_hex[1],
                                      t_hex[1], t_hex[2], t_hex[2])
    if len(t_hex) == 4:
        t_hex = "{}{}{}{}{}{}{}{}".format(t_hex[0], t_hex[0], t_hex[1],
                                          t_hex[1], t_hex[2], t_hex[2],
                                          t_hex[3], t_hex[3])
    ...
    if len(t_hex) == 6:
        return (hex_to_short(t_hex[0:2]), hex_to_short(t_hex[2:4]),
                hex_to_short(t_hex[4:6]))

    return (hex_to_short(t_hex[0:2]), hex_to_short(t_hex[2:4]),
            hex_to_short(t_hex[4:6]), hex_to_short(t_hex[6:8]))
